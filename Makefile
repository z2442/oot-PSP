...
PSP_PORT_DEFAULT_BUILD_DIR := build/psp-port-gprof$(PSP_PORT_AUDIO_MIXER_VARIANT)/$(VERSION)
else
PSP_PORT_DEFAULT_BUILD_DIR := build/psp-port$(PSP_PORT_AUDIO_MIXER_VARIANT)/$(VERSION)
endif
