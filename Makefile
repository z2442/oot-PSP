...
ifeq ($(PSP_AUDIO_ME_TRANSPORT_TEST),1)
ifeq ($(PSP_AUDIO_MEDIA_ENGINE),0)
$(error PSP_AUDIO_ME_TRANSPORT_TEST requires PSP_AUDIO_MEDIA_ENGINE=1)
endif
PSP_PORT_BUILD_DIR := $(PSP_PORT_DEFAULT_BUILD_DIR)-me-transport-test
endif
...
PSP_PORT_DEFINES := \
	...
	-DOOT_PSP_AUDIO_ME_TRANSPORT_TEST=$(PSP_AUDIO_ME_TRANSPORT_TEST) \
